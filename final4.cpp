...
public:
    ...
    double orderedPrice;
    cartItem *nextItem;
    cartItem(string itemName, double orderddAmount, double orderedPrice)
    {
...
public:
    ...
    void addItem(string itemName, double orderddAmount, double orderedPrice)
    {
        cartItem *newItem = new cartItem(itemName, orderddAmount, orderedPrice);
...
void userAddToCart(newUser *tempUser, item *itemTemp)
{
    ...
    else
    {
        ...
        runningUser->addItem(itemTemp->name, orderedAmount, totalPrice);
        cout << endl;
